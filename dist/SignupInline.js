...
export function SignupInline({ audienceFields, buttonLabel = 'Get sale alerts', className, footnote = 'Email and text sale alerts. Unsubscribe anytime.', formAction, heading, intro, onAnalyticsEvent, onSuccess, privacyUrl = SMS_TERMS_URL, source, sourcePath, }) {
