...
export type SignupPopupAnalyticsEvent =
  | { name: 'signup_popup_shown'; trigger: string; source: string }
  | { name: 'signup_popup_dismissed'; source: string }
  | { name: 'signup_popup_submit_attempt'; source: string }
  | { name: 'signup_popup_submit_error'; reason: string; source: string }
  | {
